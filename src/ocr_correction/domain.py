...
class TextSnippet(BaseModel):
    ...
    confidence: float | None = Field(default=None, description="Confidence score from the OCR engine.")
...
class Document(BaseModel):
    ...
    detected_language: str = Field(..., description="The detected or provided language code used for correction.")
    snippets: list[TextSnippet] = Field(default_factory=list, description="Individual text snippets making up the document.")
